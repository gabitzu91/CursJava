package curs8;
/*luam un array 
 * facem o metoda care sa afle indexul unui element pe care in dam ca param al metodei
...
public class FindIndexOfElementInArray {
	...
	public static void main(String[] args) {
		...
		rezolvareCuFor("mov");
		rezolvareCuForEach("verde");
		rezolvareCuWhile("rosu");
		rezolvareCuDoWhile("galben");
	}
